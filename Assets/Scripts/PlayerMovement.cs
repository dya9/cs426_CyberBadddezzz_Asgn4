...
//         //enable camera/audio for the owning player
//         if (!IsOwner) return;
...
//     //client can request it even if ownership rules differ
//     //despawn over the network, so clients don't stack bullets 
//     [ServerRpc(RequireOwnership = false)]
//     private void BulletSpawningServerRpc(Vector3 position, Quaternion rotation)
//     {
//         //making bullet on server 
...
//             return;
//         }
//         //spawning object on network so all clients can see
//         netObj.Spawn(true);

//         Rigidbody rb = newBullet.GetComponent<Rigidbody>();
//         if (rb != null)
//         {
//             //resetting previous vel
